 ...
 * Major version.
 */
#define	KCGI_VMAJOR	1

/*
 * Minor version.
 */
#define	KCGI_VMINOR	0
...
enum	krequ {
	...
	KREQU_ACCESS_CONTROL_REQUEST_HEADERS,
	KREQU_ACCESS_CONTROL_REQUEST_METHOD,
	KREQU_AUTHORIZATION,
	KREQU_DEPTH,
	KREQU_FROM,
	KREQU_HOST,
...
enum	kresp {
	...
	KRESP_ACCESS_CONTROL_EXPOSE_HEADERS,
	KRESP_ACCESS_CONTROL_MAX_AGE,
	KRESP_ACCEPT_RANGES,
	KRESP_AGE,
	KRESP_ALLOW,
	KRESP_CACHE_CONTROL,
